...
public class Company {
	...
	private boolean employeeIsEligible(Employee emp) 
	{
		...
		if (req >= 2) return true;
		// if any of the retirement conditions are NOT true:
		return false;
	}
	...
	{
		empList.removeIf((Employee emp) -> employeeIsEligible(emp)); 
		// ^^^ Are we going to cover this syntax at some point?
