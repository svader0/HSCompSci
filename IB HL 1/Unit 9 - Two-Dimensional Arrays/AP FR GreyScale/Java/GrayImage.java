public class GrayImage {
	 ...
	 * at position (row, col) by the value of the pixel at position (row + 2, col +
	 * 2) if it exists. Resulting values that would be less than BLACK are replaced
	 * by BLACK. Pixels for which there is no pixel at position (row + 2, col + 2)
	 * are unchanged.
	 */
